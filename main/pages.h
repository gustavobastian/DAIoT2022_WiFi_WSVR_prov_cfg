...
<body>\
<div id='config'>\
<h1>ESP32 App Config</h1>\
<script>\
if (window.location.search.substr(1) != '')\
{\
document.getElementById('config').display = 'none';\
document.body.innerHTML ='<h1>ESP32 App Config</h1>The new settings have been sent to the device.<br/>The page will refresh soon automatically...';\
...
<tr>\
<td>SSID</td>\
<td><input type='text' name='ssid' value='%s' placeholder='SSID of the new network'/></td>\
</tr>\
<tr>\
<td>Password</td>\
<td><input type='text' name='password' value='%s' placeholder='Password of the new network'/></td>\
</tr>\
<tr>\
<td></td>\
